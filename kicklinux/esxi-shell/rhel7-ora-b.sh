...
HOSTNAME=rhel7-ora-b

VMID=`ssh root@192.168.8.103 "vim-cmd vmsvc/getallvms" | grep ${HOSTNAME} | cut -d\  -f1`
ssh root@192.168.8.103 "vim-cmd vmsvc/power.shutdown ${VMID}"
ssh root@192.168.8.103 "vim-cmd vmsvc/power.off ${VMID}"
